...
<!-- Mirrored from uigaint.com/demo/html/anfra_2/version1/covid-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jan 2022 12:42:17 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="covid-test-wrap test-step {{ $item == 0 ? 'active' : '' }}">
                  ...
                  <div class="step-block">
                    <div class="form-group">
                      <input type="checkbox" name="package-plan" class="form-control" id="{{"one" . $value->id}}">
                      <label for="{{"one" . $value->id}}"> {{$value->answer1}}</label>
                    </div>
                    <div class="form-group">
                      <input type="checkbox" name="package-plan" class="form-control" id="{{"tow" . $value->id}}">
                      <label for="{{"tow" . $value->id}}"> {{$value->answer2}}</label>
                    </div>
                    <div class="form-group">
                      <input type="checkbox" name="package-plan" class="form-control" id="{{"thr" . $value->id}}">
                      <label for="{{"thr" . $value->id}}"> {{$value->answer3}}</label>
                    </div>
                    <div class="form-group">
                      <input type="checkbox" name="package-plan" class="form-control" id="{{"for" . $value->id}}">
